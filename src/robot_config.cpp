...
namespace bot {
    ...
    namespace motors {
        vex::motor leftA = vex::motor(vex::PORT12, vex::ratio6_1, false);
		vex::motor leftB = vex::motor(vex::PORT11, vex::ratio6_1, true);
		vex::motor leftC = vex::motor(vex::PORT20, vex::ratio6_1, true); 

		vex::motor rightA = vex::motor(vex::PORT2, vex::ratio6_1, true);
		vex::motor rightB = vex::motor(vex::PORT1, vex::ratio6_1, false);
		...
		vex::motor upper = vex::motor(vex::PORT14, vex::ratio18_1, true);
		vex::motor lower = vex::motor(vex::PORT5, vex::ratio6_1, true);
		vex::motor_group intake = vex::motor_group(upper, lower);
    }

    namespace sensors {
        bot::Inertial imu(vex::PORT9);
        vex::distance left_dist = vex::distance(vex::PORT15);
        vex::distance right_dist = vex::distance(vex::PORT8);
        vex::distance back_dist = vex::distance(vex::PORT7);
		vex::distance front_dist = vex::distance(vex::PORT13);
