...
namespace bot {
    ...
    namespace autons {
        ...
        void left_4_3() {
            ...
            vex::task::sleep(2200);
            dt.drive(50, 500, 30, -135);
            dt.drive(-200, 500, 70, -135);
            vex::task::sleep(300);
        ...
        void sawp() {
            ...
            dt.coast();
            dt.drive(100, 700, 40, -90);
            dt.drive(600, 1000, 50, 45);
            dt.drive(400, 800, 60, 0);
            bot::motors::intake.stop();
            bot::motors::lower.spin(vex::forward, 100, vex::percent);
        ...
        void skills() {
            ...
            dt.turn_to_heading(-45, 1500, 80);
            bot::motors::lower.stop();
            bot::motors::intake.spin(vex::reverse, 5.0, vex::volt);
            vex::task intake_stop_task = vex::task([]() -> int {
                vex::task::sleep(500);
                bot::motors::intake.stop();
                return 0;
            });
            ...
            else dsr_distance = left_distance_2 - 720.0;
            bot::pistons::match_load_piston.set(true);
